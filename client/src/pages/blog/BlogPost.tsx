  ...
  return (
    <div className="container mx-auto px-4 md:px-8 max-w-5xl py-12 md:py-16">
      <div className="grid md:grid-cols-12 gap-10 lg:gap-16">
        <div className="md:col-span-8 prose prose-base md:prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-growmax-black prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:mt-12 prose-h2:mb-5 prose-h2:pb-3 prose-h2:border-b prose-h2:border-gray-200 prose-h3:text-xl prose-h3:md:text-2xl prose-h3:mt-8 prose-h3:mb-3 prose-h4:text-lg prose-h4:mt-6 prose-h4:mb-2 prose-p:text-gray-600 prose-p:leading-[1.8] prose-p:mb-5 prose-a:text-growmax-red prose-a:no-underline hover:prose-a:underline prose-img:border prose-img:border-gray-200 prose-li:text-gray-600 prose-li:leading-[1.8] prose-strong:text-growmax-black prose-strong:font-semibold prose-table:text-sm prose-th:bg-gray-50 prose-th:font-semibold prose-th:text-growmax-black prose-td:border-gray-200">
