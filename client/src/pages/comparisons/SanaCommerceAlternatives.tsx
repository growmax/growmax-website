...
const competitors = [
  {
    ...
    highlight: true,
    description: "The connected B2B revenue platform purpose-built for industrial distributors. Native Zoho & SAP integration, offline field sales app, multi-warehouse inventory, and partner commerce portal — without the $100K+ implementation costs of Sana Commerce.",
    pros: [
    ...
    pricing: "From $199/mo",
    bestFor: "Industrial distributors, electrical wholesalers, building materials companies needing fast ERP-connected B2B commerce",
    rating: "4.8",
  },
  {
    name: "Sana Commerce",
  ...
  },
  {
    ...
    cons: [
      ...
      "No native Zoho or SAP connector",
...
const pricingComparison = [
  ...
  { label: "Free Trial", growmax: "14 days", sana: "No", oro: "No", bigcommerce: "Demo only", shopify: "No" },
  { label: "Setup Fee", growmax: "$0", sana: "$50K-$200K+", oro: "$30K-$150K+", bigcommerce: "Custom", shopify: "$0" },
...
const whySanaUsersSwitch = [
  {
    ...
    description: "Sana Commerce implementations typically cost $50K-$200K+ before you even go live. Growmax deploys for $0 setup fee with a 2-4 week timeline."
  },
  {
    icon: Smartphone,
    title: "No Mobile App for Field Sales",
    description: "Sana Commerce has no native mobile app for field sales reps. Growmax includes iOS and Android apps with offline ordering, GPS visit logging, and customer-specific pricing."
  },
  {
    icon: Server,
    title: "ERP Lock-In Is Risky",
    description: "Sana only works with SAP or Dynamics. If you switch ERPs, you lose your entire commerce platform. Growmax connects to Zoho, SAP, QuickBooks, and any ERP via API."
  },
  {
    icon: Package,
    title: "Slow Time-to-Value",
    description: "4-8 month implementations mean you're paying for a platform you can't use. Growmax goes live in weeks, so you start generating ROI immediately."
  },
  {
    icon: Building2,
    title: "No Partner Commerce",
    description: "Sana Commerce has no partner portal. Growmax includes a full partner commerce portal where channel partners independently place orders and manage accounts."
  },
  {
    icon: Zap,
    title: "Complex Pricing Model",
    description: "Sana's order-volume-based pricing makes costs unpredictable. Growmax offers simple, transparent pricing starting at $199/mo with unlimited portal users."
  },
];
...
const faqs = [
  {
    ...
    answer: "Growmax is the best Sana Commerce alternative for industrial distributors and manufacturers. It offers native ERP integration (Zoho, SAP, QuickBooks), an offline mobile app for field sales, multi-warehouse inventory management, and a partner commerce portal — all at a fraction of Sana's cost with 2-4 week implementation."
  },
  {
    question: "How does Growmax compare to Sana Commerce pricing?",
    answer: "Growmax starts at $199/month with $0 setup fee and 2-4 week implementation. Sana Commerce typically costs $1,500+/month with $50K-$200K+ implementation fees and 4-8 month timelines. Growmax provides more value at significantly lower total cost of ownership."
  },
  {
    question: "Can I migrate from Sana Commerce to Growmax?",
    answer: "Yes. Growmax provides a structured migration path from Sana Commerce. Our team helps export your product catalog, customer-specific pricing, and order history. Most Sana Commerce migrations complete within 2-4 weeks with zero data loss."
  },
  {
    question: "Does Growmax integrate with SAP like Sana Commerce?",
    answer: "Yes. Growmax offers native SAP integration with bidirectional real-time sync. Unlike Sana, Growmax also integrates with Zoho, QuickBooks, and other ERPs — so you're never locked into a single ERP vendor."
  },
  {
    question: "Does Growmax have a mobile app?",
    answer: "Yes. Growmax includes native iOS and Android apps for field sales reps with offline ordering capability, GPS visit logging, customer-specific pricing, and real-time inventory visibility — a feature Sana Commerce does not offer."
  },
  {
    question: "What industries does Growmax serve?",
    answer: "Growmax is purpose-built for industrial distributors, electrical wholesalers, building materials companies, food & beverage distributors, automotive aftermarket suppliers, and manufacturers with complex B2B pricing structures."
  },
];
      ...
      <section className="py-24 bg-growmax-black text-white">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          <div className="mb-16">
            ...
            <h2 className="text-3xl font-bold tracking-tight mb-4">How to Migrate from Sana Commerce to Growmax</h2>
            <div className="w-16 h-1 bg-growmax-red"></div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6" data-testid="section-migration-steps">
            {[
              ...
              { step: "03", title: "Connect Your ERP", description: "Link Growmax directly to your SAP, Zoho, or QuickBooks instance. Native connectors — no middleware or custom development." },
      ...
      <section className="py-32 text-center bg-white">
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tighter text-growmax-black" data-testid="text-cta-title">
            Ready to replace Sana Commerce?<br/>Deploy Growmax today.
          </h2>
