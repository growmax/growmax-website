...
export default function ElectricalDistributors() {
  return (
    <div className="min-h-screen bg-white pt-16 selection:bg-growmax-red selection:text-white">
      <SEOHead
        ...
        structuredData={webPageSchema({
          ...
          keywords: [
            ...
            "electrical distributor ordering platform",
            "electrical wholesale B2B commerce",
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-3xl sm:text-5xl font-bold tracking-tighter mb-8 uppercase leading-[1.1]" data-testid="text-casestudy-title">Electrical Manufacturer Goes Digital</h2>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tighter mb-6 uppercase" data-testid="text-regional-title">
              Electrical Distribution<br/>Across America
            </h2>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto" data-testid="text-seo-keywords">
            {[
              ...
              "multi-warehouse electrical distribution",
              "electrical distributor ordering platform",
              "electrical wholesale B2B platform",
              "SAP integrated electrical commerce"
            ].map((keyword, i) => (
      ...
      <WhichGrowmax industry="Electrical" />
    </div>
  );
}